...
(module
  (import "tinycloud" "sql_query" (func $op (param i32 i32) (result i32 i32)))
  ...
  (func (export "run") (param i32 i32) (result i32 i32)
    (call $op (i32.const 0) (i32.const 65))
    (drop) (drop)
    (i32.const 128) (i32.const 11))
  (data (i32.const 0) "{\"action\":\"execute\",\"sql\":\"ATTACH DATABASE 'x' AS y\",\"params\":[]}")
