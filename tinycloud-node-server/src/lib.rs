...
pub async fn app(
    ...
    // P0 walking skeleton: a stub handle with no config surface yet
    // (specs/compute-service-implementation-plan.md). The artifact repo,
    // backend registry, and routine-key derivation handle are wired in P1/P2.
    #[cfg(feature = "compute")]
