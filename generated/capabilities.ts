...
// Source: capabilities.json (registry version 1, sha256 66e9ba8f12562543a99fcd1358665c1fedfc7be0e78563d3c9e7ba3dd6018f44).
//
...
export const REGISTRY_SOURCE_SHA256 = "66e9ba8f12562543a99fcd1358665c1fedfc7be0e78563d3c9e7ba3dd6018f44" as const;
 ...
 */
export const REGISTRY_SOURCE_GIT_SHA = "66fce3719c526577fbe62d958f9d907b18d12c3a" as const;
...
export const CAPABILITIES: readonly CapabilityEntry[] = [
  ...
  { urn: "tinycloud.compute/execute", service: "tinycloud.compute", status: "active" },
  { urn: "tinycloud.compute/deploy", service: "tinycloud.compute", status: "active" },
  { urn: "tinycloud.compute/list", service: "tinycloud.compute", status: "reserved" },
  { urn: "tinycloud.compute/*", service: "tinycloud.compute", status: "active", implies: ["tinycloud.compute/deploy", "tinycloud.compute/execute"] },
...
export const IMPLICATIONS: Readonly<Record<string, readonly string[]>> = {
  "tinycloud.compute/*": ["tinycloud.compute/deploy", "tinycloud.compute/execute"],
