...
export default function(data) {
    ...
    const ok = check(res, {
        ...
        'trace id present': (r) => !!r.headers['TinyCloud-Trace-Id'],
    });
...
export function teardown(data) {
    const list_invocation = http.post(`${signer}/sessions/0/invoke`,
    ...
    list_invocation['Content-Type'] = 'application/json';
    ...
    for (const key of keys) {
        ...
        const deleteRes = http.post(`${tinycloud}/invoke`,
            "",
            {
